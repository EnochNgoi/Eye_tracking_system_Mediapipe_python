...
def colorBackgroundText(frame, text, font, size, position, thickness, bg_color, text_color=(255, 255, 255), pad_x=0, pad_y=0):
    cv.putText(frame, text, position, font, size, bg_color, thickness + 2 * pad_x, cv.LINE_AA)
    cv.putText(frame, text, position, font, size, text_color, thickness, cv.LINE_AA)
